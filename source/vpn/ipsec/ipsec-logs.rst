...
Entries found in these logs are covered in depth in `The pfSense Book <https://www.pfsense.org/our-services/gold-membership.html>`__, and
some errors are covered in :doc:`IPsec Troubleshooting </vpn/ipsec/ipsec-troubleshooting>`.

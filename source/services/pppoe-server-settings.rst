...
restrict network access on a given interface, either wired or wireless.

The setup is very similar to the PPTP Server.
...
Multiple PPPoE servers may be defined for separate interfaces.
